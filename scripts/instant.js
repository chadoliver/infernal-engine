var Instant = (function () { 
	...
	function Instant (sampleTime, zeroTime) {
	...
	Instant.prototype.getDelay = function(sampleTimeSpeedup, simulationTimeOffset) {
	...
	Instant.prototype.start = function(sampleTimeSpeedup, simulationTimeOffset) {
	...
	Instant.prototype.pause = function() {
	...
	Instant.prototype.scrub = function(sampleTimeSpeedup, simulationTimeOffset) {
	...
	Instant.prototype.onCountdownFires = function() {

		this.timeoutHandle = null;
		this.notifyListeners(-1);	// any negative number would do here. 
	}

	Instant.prototype.notifyListeners = function(delay) {
	...
	Instant.prototype.registerListener = function(listener) {
