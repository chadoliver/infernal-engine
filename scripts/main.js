starter.wait(function () {
    ...
    var wordCloud = new WordCloud('wordcloud', 300, 'Open Sans');
    ...
    var representativeImage = new RepresentativeImage('thumbnail');
    ...
    var dataModel = new DataModel(timeController, markerSet, wordCloud, messageBoard, representativeImage);
